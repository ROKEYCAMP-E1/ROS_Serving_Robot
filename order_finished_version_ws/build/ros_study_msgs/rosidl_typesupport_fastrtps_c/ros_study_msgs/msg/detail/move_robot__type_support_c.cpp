...
#include "ros_study_msgs/msg/detail/move_robot__rosidl_typesupport_fastrtps_c.h"
...
using _MoveRobot__ros_msg_type = ros_study_msgs__msg__MoveRobot;
  ...
  void * untyped_ros_message)
{
  ...
  _MoveRobot__ros_msg_type * ros_message = static_cast<_MoveRobot__ros_msg_type *>(untyped_ros_message);
  // Field name: topic_move_robot
  {
    cdr >> ros_message->topic_move_robot;
  }
...
size_t get_serialized_size_ros_study_msgs__msg__MoveRobot(
  const void * untyped_ros_message,
...
static uint32_t _MoveRobot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_study_msgs__msg__MoveRobot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_study_msgs
size_t max_serialized_size_ros_study_msgs__msg__MoveRobot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_study_msgs__msg__MoveRobot;
    is_plain =
      (
...
static size_t _MoveRobot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_study_msgs__msg__MoveRobot(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, msg, MoveRobot)() {
