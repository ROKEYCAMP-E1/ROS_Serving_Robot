...
static const _MoveRobot_type_support_symbol_names_t _MoveRobot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, msg, MoveRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_study_msgs, msg, MoveRobot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_study_msgs, msg, MoveRobot)() {
  return &::ros_study_msgs::msg::rosidl_typesupport_c::MoveRobot_message_type_support_handle;
}
