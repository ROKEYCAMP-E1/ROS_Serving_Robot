...
{
  new (message_memory) ros_study_msgs::msg::MoveRobot(_init);
}

void MoveRobot_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_study_msgs::msg::MoveRobot *>(message_memory);
  typed_message->~MoveRobot();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveRobot_message_member_array[1] = {
  {
    ...
    offsetof(ros_study_msgs::msg::MoveRobot, topic_move_robot),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveRobot_message_members = {
  ...
  1,  // number of fields
  sizeof(ros_study_msgs::msg::MoveRobot),
...
{
  return &::ros_study_msgs::msg::rosidl_typesupport_introspection_cpp::MoveRobot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_study_msgs, msg, MoveRobot)() {
  return &::ros_study_msgs::msg::rosidl_typesupport_introspection_cpp::MoveRobot_message_type_support_handle;
}
